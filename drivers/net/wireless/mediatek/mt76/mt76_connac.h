...
#define MT76_CONNAC_MAX_HW_WLANS		(HW_BSSID_MAX - HW_BSSID_0 + 1)
#define MT76_CONNAC_MAX_EXT_WLANS		(EXT_BSSID_MAX - EXT_BSSID_START)
#define MT76_CONNAC_MAX_REPEATER_WLANS		(REPEATER_BSSID_MAX - REPEATER_BSSID_START + 1)
...
static inline bool is_mt7921k(struct mt76_dev *dev)
{
	return mt76_chip(dev) == 0x7961 && dev->device_id == 0x0608;
}
