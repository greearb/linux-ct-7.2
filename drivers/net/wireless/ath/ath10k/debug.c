...
#if 0
static void ath10k_debug_fw_ratepwr_table_process(struct ath10k *ar, struct sk_buff *skb)
{
	size_t sz = skb->len;
...
#if 0
static void ath10k_debug_fw_powerctl_table_process(struct ath10k *ar, struct sk_buff *skb)
{
	size_t sz = skb->len;
